              ...
              <div className="flex flex-wrap gap-4 w-full md:w-auto">
                ...
                {isFullMenuPage && (
                  <select
                    ...
                    className="select-field flex-1 md:w-auto min-w-[140px] order-1 md:order-2"
                    id="category-select"
                  >
                ...
                <select
                  ...
                  className="select-field flex-1 md:w-auto min-w-[140px] order-2 md:order-3"
                  id="sort-select"
                >
                ...
                {category?.toLowerCase() === 'flowers' && (
                  <select
                    ...
                    className="select-field flex-1 md:w-auto min-w-[140px] order-3 md:order-1"
                    id="mood-select"
                  >
