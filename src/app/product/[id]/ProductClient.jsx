          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5">
            ...
            <div className="lg:col-span-2 flex flex-col bg-pc-dark border-r border-pc-border">
              <div className="relative aspect-square md:aspect-auto flex-1">
                ...
                {product.featured && (
                  <div className="absolute top-4 left-4 bg-pc-gold text-white text-sm font-bold px-3 py-1.5 rounded-full flex items-center gap-1 shadow-lg">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z"/></svg>
                    Featured
                  </div>
                )}
              </div>
