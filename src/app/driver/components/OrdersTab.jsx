              ...
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  {order.deliveryMethod === 'DELIVERY' && order.deliveryAddress && (
                    <div className="mt-2 flex items-center flex-wrap gap-2 text-sm text-pc-muted">
                      <div className="flex items-center gap-1.5 min-w-0">
                        ...
                        <span className="text-white font-medium break-words">{order.deliveryAddress}</span>
                      </div>
