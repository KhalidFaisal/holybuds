            ...
            <form onSubmit={handleSubmit} className="glass-card p-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <span className={`absolute top-2 right-2 font-black flex items-center justify-center transition-all ${
                      form.deliveryMethod === 'PICKUP'
                        ? 'w-6 h-6 rounded-full bg-pc-black text-pc-green text-xs shadow-sm sm:w-auto sm:h-auto sm:px-2.5 sm:py-0.5 sm:text-[11px] sm:gap-1'
                        : 'w-5 h-5 rounded-full border-2 border-pc-border/80'
                    }`}>
                      {form.deliveryMethod === 'PICKUP' && (
                        <>
                          <span>✓</span>
