        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <Link href="/menu?category=FLOWER" className="block text-pc-muted text-sm hover:text-white transition-colors">Flowers</Link>
              <Link href="/menu?category=EDIBLE" className="block text-pc-muted text-sm hover:text-white transition-colors">Edibles</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-pc-muted text-sm">
              <p className="flex items-center gap-3">
                <svg className="w-5 h-5 text-pc-green shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
