...
export function TierIcon({ type, className = 'w-3.5 h-3.5' }) {
  ...
  if (type === 'ruby') {
    return (
      <svg className={`${className} text-rose-400`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  if (type === 'emerald') {
    return (
      <svg className={`${className} text-emerald-400`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  if (type === 'platinum') {
    return (
      <svg className={`${className} text-cyan-300`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  if (type === 'silver') {
    return (
      <svg className={`${className} text-slate-300`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  if (type === 'bronze') {
    return (
      <svg className={`${className} text-amber-600`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  return (
    <svg className={`${className} text-pc-green`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2 mb-1">
              ...
              <span className={`text-xs font-bold px-2.5 py-0.5 rounded-full border flex items-center gap-1.5 ${tier.badgeClass}`}>
                <TierIcon type={tier.type} />
                <span>{tier.name}</span>
                <span className="text-[10px] opacity-70 font-normal">Tier {tier.tier}</span>
              </span>
            </div>
