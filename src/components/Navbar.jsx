        ...
        <div className="flex items-center justify-between h-16 md:h-20 relative">
          ...
          <div className="flex items-center gap-1 sm:gap-4 ml-auto" ref={searchContainerRef}>
            ...
            >
              ...
              {totalItems > 0 && (
                <span className="absolute -top-1 -right-1 bg-pc-green text-pc-black text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center animate-scale-in">
                  {totalItems}
                </span>
              )}
            </button>
